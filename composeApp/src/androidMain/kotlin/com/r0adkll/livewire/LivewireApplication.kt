  ...
  override fun onCreate() {
    ...
    with (ServiceLocator.database) {
      scope.launch {
        ...
        tasksQueries.insert(Tasks(0, "Make scripting work", 0, 0))
        tasksQueries.insert(Tasks(1, "Update bits and bobs", 1, 1))
        tasksQueries.insert(Tasks(2, "Scrub with steel wool", 2, 2))
      }
    }
  }
}
